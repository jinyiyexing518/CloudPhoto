...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    icon: "🎬",
    title: "自动故事",
    desc: "选择文件夹一键生成幻灯片，支持淡入淡出/滑动/缩放效果",
    details:
      "在「🎬 自动故事」标签选择照片来源和切换效果，点击「开始播放」进入全屏幻灯片。支持键盘操作（←→切换，Esc退出），顶部进度条可点击跳转。",
  },
  {
    id: "time-capsule",
    date: "2026-06-02",
    icon: "💌",
    title: "时光胶囊",
    desc: "将照片锁定到未来某天，到期后解锁查看",
    details:
      "在「💌 时光胶囊」标签新建胶囊：选择照片、设定解锁日期，胶囊将锁定显示倒计时；到期后自动解锁，可点击打开浏览封存的照片。数据存储在本地。",
  },
  {
    id: "memory-map",
    date: "2026-06-02",
    icon: "🗺️",
    title: "记忆地图",
    desc: "含 GPS 信息的照片在世界地图上展示拍摄地点",
    details:
      "在「🗺️ 记忆地图」标签查看所有含位置信息的照片分布。上传时自动读取图片 EXIF GPS 数据并存储。点击地图上的照片图标可查看详情并跳转到时间线。",
  },
  {
    id: "on-this-day",
    date: "2026-06-02",
    icon: "📅",
    title: "历史上的今天",
    desc: "时间线顶部自动显示往年同一天拍摄的照片",
    details:
      "每次进入时间线，若往年同月同日有照片，会在顶部出现「历史上的今天」卡片，按年份分组展示缩略图，点击跳转到对应照片。",
  },
  {
